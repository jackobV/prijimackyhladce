        ...
        <main>
            ...
            <section className="pt-20">
                <LandingPageHeroDynamic title={
                    <h1 className="max-w-2xl text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl lg:col-span-2 xl:col-auto leading-relaxed">
                        Přijímačky CERMAT? <br /> Vyzkoušej si je!
                    </h1>
                } />
            </section>
