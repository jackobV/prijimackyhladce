import LandingPageHeroCallout from "@/app/(general)/(components)/landingPageHeroCallout";
import classroomPhoto from "../../(media)/classroompicture-copy.jpg"
import Image from "next/image";
export default function LandingPageHero(){
    return(
        <div className="px-4 flex flex-col md:flex-row max-w-5xl mx-auto gap-x-10">
