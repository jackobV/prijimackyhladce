...
import coverImage from '../(media-zarok)/bookcover.png'
import Button from "@/app/(general)/prijimackyzarok/(components-prijimackyzarok)/Button";
import GridPattern from "@/app/(general)/prijimackyzarok/(components-prijimackyzarok)/GridPattern";
import {StarRating} from "@/app/(general)/prijimackyzarok/(components-prijimackyzarok)/StarRating";
...
export default function LandingHeroZaRok() {
    return (
